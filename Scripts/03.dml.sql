...
insert into product(CODE,NAME,PRICE,PICTUREURL,DESCRIPTION) values(product_seq.nextval, '개념을 콕콕 잡아주는 데이터베이스', 27000, 'db.jpg', '데이터베이스에 관한 모든 것을 쉽고 재미있게 정리한 교재...');
...
UPDATE BOARD SET READCOUNT = READCOUNT + 1 WHERE NUM =28;
