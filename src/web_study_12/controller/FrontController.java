...
@WebServlet(
		urlPatterns = { "*.do" }, 
		loadOnStartup = 1,				//혹시나 컨트롤러가 여러개일 경우 그중아 첫번째로 올려줘~!
		initParams = { 
...
public class FrontController extends HttpServlet {
	...
	private Map<String, Command> handlerMap = new HashMap<>();		//선언
...
//				System.out.println(entry.getKey() + " : " + entry.getValue());
				...
				Command command = (Command) cls.newInstance();				//디폴드 값 생성, 생성 하지 않으면 에러뜸, 꼭 생성해줘야 됨
