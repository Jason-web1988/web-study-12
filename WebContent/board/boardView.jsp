...
<script>
 $(function(){
	...
	$('#update').on("click", function(){
		alert("등록된 비밀번호 : " + document.getElementById("checkPass").value);
		alert("입력한 비밀번호 : " + $('#pass').val());
...
<body>
	...
	<div id="wrap" align="center">
		...
		<table>
			...
			<tr>
				<th>작성일</th>
				<td id="writeDate"><fmt:formatDate value="${board.writeDate}" /></td>
				<th>조회수</th>
				<td id="readCount">${board.readCount}</td>
				<%-- <td><input type="hidden" value="${board.pass}" ></td> --%>
			</tr>
			...
			<tr>
				...
				<th>이메일</th>
				<td><input type="email" id="email" value="${board.email}" readonly="readonly"></td>

			</tr>
			<tr>
				<th>비밀번호</th>
				<td colspan="3" > 
				<input type="hidden" id="checkPass" value="${board.pass}"> 
				<input type="password" id="pass"></td>
				
			</tr>
			<tr>
				<th>내용</th>
				<td colspan="3"><textarea cols="250" rows="15" id="content"
